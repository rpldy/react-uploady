...
vi.mock("../processQueueNext", () => ({ default: vi.fn() }));
vi.mock("../processAbort", () => ({
    processAbortItem: vi.fn(),
    processAbortBatch: vi.fn(),
    processAbortAll: vi.fn(),
}));
...
describe("queue tests", () => {
    ...
    const mockSenderOn = vi.fn((name, handler) => {
